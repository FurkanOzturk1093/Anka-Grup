        ...
        <div className="contact-content">
          ...
          <div className="contact-form">
            <div>
              ...
              <p>
                Bize ulaşın ve size yardımcı olmamızı istediğiniz konuyu
                belirtin.
              </p>
              ...
              <div className="from-inputs">
                <div className="type_1">
                  <label htmlFor="topic" className="form-label">
                    HANGI KONUDA YARDIMCI OLABILIRIZ?
                  </label>
          ...
          <div className="left-info">
            <div className="content">
              <div className="ak-section-heading ak-style-1">
                <div className="background-text">İLETİŞİM</div>
                <h2 className="ak-section-title">İLETİŞİM</h2>
                <p className="ak-section-subtitle">
                  ANKA Grup olarak müşteri memnuniyeti bizim için önemlidir.
                  Sizlere daha iyi hizmet verebilmek için her zaman
                  yanınızdayız.
                </p>
              </div>
            </div>
          ...
          <div className="right-info">
            ...
            <div className="info-card">
              ...
              <div className="d-flex gap-2">
                ...
                <div>
                  <p>Büyük sanayi 1.Cad Arpacıoğlu 2 işhanı no:95/1 </p>
                </div>
              </div>
            </div>
            <div className="info-card">
